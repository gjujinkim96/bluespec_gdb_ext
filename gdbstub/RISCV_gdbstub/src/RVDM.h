...
extern const uint16_t dm_addr_custom_reg;
...
extern const uint16_t dm_command_access_reg_regno_custom_0;
extern const uint16_t dm_command_access_reg_regno_custom_10;
