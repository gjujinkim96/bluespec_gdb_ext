...
const uint16_t dm_addr_custom_reg      = 0x61;
...
void fprint_dm_addr_name (FILE *fp, char *pre, const uint16_t dm_addr, char *post)
{
    ...
    else if (dm_addr == dm_addr_custom_reg) fprintf (fp, "custom_reg");
...
const uint16_t dm_command_access_reg_regno_custom_0 = 0x1041;
const uint16_t dm_command_access_reg_regno_custom_10 = 0x1051;
